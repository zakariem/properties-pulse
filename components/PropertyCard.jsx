      ...
      <div className="p-4">
        ...
        <div className="flex justify-center gap-4 text-green-900 text-sm mb-4">
          {property.rates.nightly && (
            <p>
              <FaMoneyBill className="inline" /> Nightly: ${property.rates.nightly}
            </p>
          )}
          {property.rates.weekly && (
            <p>
              <FaMoneyBill className="inline" /> Weekly: ${property.rates.weekly}
            </p>
          )}
          {property.rates.monthly && (
            <p>
              <FaMoneyBill className="inline" /> Monthly: ${property.rates.monthly}
            </p>
          )}
        </div>
